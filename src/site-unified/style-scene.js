...
const STAGES = [
  {
    id: 's01',
    photos: [
      { id: 'estilo-01', rot: -1.4, enter: [34, -8], exit: [-36, -6], fasteners: [['pin.webp','tc',0], ['laco-04.webp','tr',6]] },
      { id: 'estilo-02', rot: 1.2, enter: [34, -4], exit: [36, -12], fasteners: [['laco-02.webp','tc',0]] },
      { id: 'estilo-03', rot: 0.9, enter: [34, 8], exit: [36, 10], fasteners: [['laco-03.webp','tc',2]] },
      { id: 'estilo-10', rot: -0.6, enter: [36, 12], exit: [34, 16], fasteners: [['pin.webp','tl',0]] },
      { id: 'estilo-11', rot: -1.5, enter: [0, 28], exit: [-8, 26], fasteners: [['laco-05.webp','tc',0]] },
      { id: 'estilo-16', rot: 1.6, enter: [10, 24], exit: [6, 24], fasteners: [['pin.webp','tc',0]] },
    ],
    deco: [
      { key: 'styleicon', file: 'styleicon.webp', rot: -4, enter: [-18, 10], exit: [-20, 12] },
      { key: 'teamo', file: 'teamo.webp', rot: 2, enter: [-22, 18], exit: [-24, 20] },
      { key: 'vogue', file: 'vogue.webp', rot: 2, enter: [24, -10], exit: [28, -10] },
      { key: 'tiger02', file: 'tiger02.webp', rot: 0, enter: [-26, 18], exit: [-30, 22] },
      { key: 'boca02', file: 'boca02.webp', rot: -6, enter: [14, -18], exit: [16, -20] },
      { key: 'camera', file: 'camera.webp', rot: -4, enter: [14, 18], exit: [18, 20] },
      { key: 'flor-02', file: 'flor-02.webp', rot: 4, enter: [22, 12], exit: [24, 16] },
      { key: 'coracao-01', file: 'coracao-01.webp', rot: 0, enter: [10, 8], exit: [12, 8] },
      { key: 'pin', file: 'pin.webp', rot: -4, enter: [0, 16], exit: [0, 18] },
    ],
  },
  {
    id: 's02',
    photos: [
      { id: 'estilo-04', rot: -1.3, enter: [-34, -8], exit: [-38, -10], fasteners: [['pin.webp','tc',0]] },
      { id: 'estilo-05', rot: 1.1, enter: [-26, -14], exit: [-30, -14], fasteners: [['laco-05.webp','tc',0]] },
      { id: 'estilo-06', rot: 1.4, enter: [34, -8], exit: [38, -8], fasteners: [['pin.webp','tc',0]] },
      { id: 'estilo-07', rot: -0.8, enter: [0, -28], exit: [0, -30], fasteners: [['laco-03.webp','tc',3]] },
      { id: 'estilo-12', rot: -1.2, enter: [-24, 24], exit: [-28, 24], fasteners: [['laco-02.webp','tc',0]] },
      { id: 'estilo-14', rot: 1.8, enter: [26, 22], exit: [30, 24], fasteners: [['pin.webp','tl',0]] },
    ],
    deco: [
      { key: 'channel', file: 'channel.webp', rot: -3, enter: [-20, -14], exit: [-24, -16] },
      { key: 'prada', file: 'prada.webp', rot: 2, enter: [26, 12], exit: [30, 16] },
      { key: 'relogio', file: 'relogio.webp', rot: 4, enter: [26, -12], exit: [30, -14] },
      { key: 'vogue02', file: 'vogue02.webp', rot: -2, enter: [0, 24], exit: [0, 26] },
      { key: 'model-02', file: 'model-02.webp', rot: 0, enter: [-12, 22], exit: [-16, 24] },
      { key: 'model-04', file: 'model-04.webp', rot: 0, enter: [12, 20], exit: [16, 22] },
      { key: 'catfashion', file: 'catfashion.webp', rot: -4, enter: [-18, 18], exit: [-20, 22] },
      { key: 'flor-04', file: 'flor-04.webp', rot: 6, enter: [24, 16], exit: [26, 18] },
      { key: 'coracao-02', file: 'coracao-02.webp', rot: 0, enter: [10, -10], exit: [12, -12] },
      { key: 'laco-05', file: 'laco-05.webp', rot: 6, enter: [-16, -20], exit: [-20, -24] },
      { key: 'vcdeixatudomaisbonito', file: 'vcdeixatudomaisbonito.webp', rot: -1, enter: [0, -24], exit: [0, -26] },
      { key: 'ficardecanto-01', file: 'ficardecanto-01.webp', rot: 0, enter: [24, 18], exit: [30, 22] },
      { key: 'flor-01', file: 'flor-01.webp', rot: -4, enter: [-20, 20], exit: [-24, 24] },
    ],
  },
  {
    id: 's03',
    photos: [
      { id: 'estilo-08', rot: -1.2, enter: [-34, -6], exit: [-38, -6], fasteners: [['pin.webp','tc',0]] },
      { id: 'estilo-09', rot: 1.4, enter: [-20, -10], exit: [-24, -12], fasteners: [['laco-03.webp','tc',0]] },
      { id: 'estilo-17', rot: -0.7, enter: [0, -26], exit: [0, -28], fasteners: [['laco-01.webp','tr',4]] },
      { id: 'estilo-18', rot: 1.1, enter: [26, -10], exit: [30, -12], fasteners: [['laco-02.webp','tc',0]] },
      { id: 'estilo-19', rot: -1.4, enter: [-18, 22], exit: [-22, 24], fasteners: [['laco-04.webp','tc',0]] },
      { id: 'estilo-22', rot: 1.8, enter: [28, 22], exit: [32, 24], fasteners: [['pin.webp','tl',0]] },
    ],
    deco: [
      { key: 'dontflash', file: 'dontflash.webp', rot: 0, enter: [-20, 18], exit: [-24, 20] },
      { key: 'coke', file: 'coke.webp', rot: -2, enter: [12, 18], exit: [16, 20] },
      { key: 'coke2', file: 'coke2.webp', rot: -6, enter: [14, 24], exit: [18, 26] },
      { key: 'botas', file: 'botas.webp', rot: 0, enter: [18, -18], exit: [22, -20] },
      { key: 'boca', file: 'boca.webp', rot: -7, enter: [0, -18], exit: [0, -20] },
      { key: 'coracao-04', file: 'coracao-04.webp', rot: 2, enter: [22, 14], exit: [24, 16] },
      { key: 'revistas', file: 'revistas.webp', rot: -3, enter: [0, 20], exit: [0, 22] },
      { key: 'cinema', file: 'cinema.webp', rot: -2, enter: [-26, 24], exit: [-30, 26] },
      { key: 'flor-03', file: 'flor-03.webp', rot: 4, enter: [26, 16], exit: [30, 18] },
      { key: 'laco-03', file: 'laco-03.webp', rot: 6, enter: [4, 26], exit: [4, 28] },
      { key: 'model-01', file: 'model-01.webp', rot: 0, enter: [-20, 14], exit: [-24, 16] },
    ],
  },
  {
    id: 's04',
    photos: [
      { id: 'estilo-13', rot: -1.2, enter: [-34, -10], exit: [-38, -12], fasteners: [['pin.webp','tc',0]] },
      { id: 'estilo-15', rot: 1.1, enter: [-16, -8], exit: [-20, -10], fasteners: [['laco-04.webp','tc',0]] },
      { id: 'estilo-20', rot: -0.6, enter: [10, -10], exit: [14, -12], fasteners: [['pin.webp','tc',0]] },
      { id: 'estilo-21', rot: 0.8, enter: [28, -10], exit: [32, -12], fasteners: [['laco-05.webp','tc',0]] },
      { id: 'estilo-23', rot: -1.2, enter: [0, 24], exit: [0, 28], fasteners: [['pin.webp','tc',0]] },
    ],
    deco: [
      { key: 'botas-02', file: 'botas-02.webp', rot: -4, enter: [-24, 18], exit: [-28, 20] },
      { key: 'cantoinferiordireito', file: 'cantoinferiordireito.webp', rot: 0, enter: [26, 22], exit: [30, 24] },
      { key: 'model-03', file: 'model-03.webp', rot: -3, enter: [-20, 12], exit: [-24, 14] },
      { key: 'model-05', file: 'model-05.webp', rot: 3, enter: [12, 12], exit: [14, 14] },
      { key: 'model-06', file: 'model-06.webp', rot: 0, enter: [18, 12], exit: [22, 14] },
      { key: 'flor-05', file: 'flor-05.webp', rot: -6, enter: [-28, 4], exit: [-30, 6] },
      { key: 'tiger', file: 'tiger.webp', rot: 0, enter: [30, 0], exit: [34, 0] },
      { key: 'camera', file: 'camera.webp', rot: -5, enter: [-18, 20], exit: [-22, 24] },
      { key: 'teamo', file: 'teamo.webp', rot: 2, enter: [12, 22], exit: [16, 24] },
      { key: 'styleicon', file: 'styleicon.webp', rot: 0, enter: [18, 24], exit: [22, 26] },
    ],
  },
];
    ...
    <div class="style-v1__section">
      <div class="style-v1__sticky">
        ...
        <div class="style-v1__scene-stage">
          ...
          <img class="style-v1__center-title" src="${assetBase}/love-scene-estilo/kit/amocomovc-estilosa.webp" alt="Eu amo como você é estilosa" draggable="false" />
