...
const STAGES = [
  {
    id: 's01',
    photos: [
      { id: 'sorriso-04', rot: -1.2, enter: [34, -4], exit: [-36, -2], fasteners: [['tape-01.webp', 'tc', -3], ['laco-01.webp', 'tr', 6]] },
      { id: 'sorriso-01', rot: -2.6, enter: [-34, 8], exit: [28, 18], fasteners: [['tape-02.webp', 'tc', 2]] },
      { id: 'sorriso-02', rot: 1.5, enter: [34, -4], exit: [36, -12], fasteners: [['tape-03.webp', 'tc', -2]] },
      { id: 'sorriso-03', rot: 1.1, enter: [34, 10], exit: [34, 14], fasteners: [['tape-04.webp', 'tc', 2]] },
      { id: 'sorriso-10', rot: -0.8, enter: [0, 28], exit: [0, 26], fasteners: [['tape-05.webp', 'tc', 0]] },
      { id: 'sorriso-16', rot: 1.7, enter: [36, 8], exit: [30, 20], fasteners: [['tape-06.webp', 'tc', 0]] },
    ],
    deco: [
      { key: 'flor-01', file: 'flor-01.webp', rot: -9, enter: [-24, 8], exit: [-32, 12] },
      { key: 'rosa', file: 'rosa.webp', rot: 4, enter: [-28, 18], exit: [-30, 24] },
      { key: 'angel-01', file: 'angel-01.webp', rot: -2, enter: [-22, -10], exit: [8, -26] },
      { key: 'youaremysunshine', file: 'youaremysunshine.webp', rot: 3, enter: [30, 0], exit: [36, 0] },
      { key: 'carta-01', file: 'carta-01.webp', rot: 3, enter: [-24, 18], exit: [-30, 26] },
      { key: 'ribbon-01', file: 'ribbon-01.webp', rot: 0, enter: [22, 10], exit: [28, 20] },
      { key: 'selo-01', file: 'selo-01.webp', rot: 5, enter: [30, -6], exit: [36, -10] },
      { key: 'laco-01', file: 'laco-01.webp', rot: 8, enter: [20, -14], exit: [26, -20] },
  ...
  },
  {
    id: 's02',
    photos: [
      { id: 'sorriso-05', rot: -1.1, enter: [-34, -4], exit: [-38, -4], fasteners: [['tape-01.webp', 'tc', -4]] },
      { id: 'sorriso-06', rot: 1.2, enter: [34, -4], exit: [38, -2], fasteners: [['tape-02.webp', 'tc', 4], ['laco-02.webp', 'tr', 9]] },
      { id: 'sorriso-07', rot: 1.2, enter: [-28, -16], exit: [-34, -18], fasteners: [['tape-03.webp', 'tc', -2]] },
      { id: 'sorriso-08', rot: -1.5, enter: [28, 14], exit: [34, 20], fasteners: [['tape-04.webp', 'tc', 2]] },
      { id: 'sorriso-09', rot: -2.1, enter: [-28, 18], exit: [-34, 24], fasteners: [['tape-05.webp', 'tc', 0]] },
      { id: 'sorriso-13', rot: 0.4, enter: [0, 28], exit: [0, 26], fasteners: [['tape-06.webp', 'tc', 0]] },
    ],
    deco: [
      { key: 'pessoafavorita', file: 'pessoafavorita.webp', rot: -2, enter: [18, -22], exit: [16, -24], kind: 'title' },
      { key: 'colar', file: 'colar.webp', rot: -8, enter: [-18, -12], exit: [-24, -18] },
      { key: 'chave', file: 'chave.webp', rot: 6, enter: [-20, 6], exit: [-24, 10] },
      { key: 'carta', file: 'carta.webp', rot: 2, enter: [-24, 18], exit: [-28, 22] },
      { key: 'bear-01', file: 'bear-01.webp', rot: 2, enter: [26, 6], exit: [30, 8] },
      { key: 'kiss-01', file: 'kiss-01.webp', rot: -8, enter: [18, 0], exit: [24, 0] },
      { key: 'laco-02', file: 'laco-02.webp', rot: 8, enter: [24, -16], exit: [28, -18] },
      { key: 'selo-02', file: 'selo-02.webp', rot: 6, enter: [-12, 16], exit: [-16, 18] },
  ...
  },
  {
    id: 's03',
    photos: [
      { id: 'sorriso-11', rot: -1.3, enter: [-34, -4], exit: [-36, -4], fasteners: [['tape-01.webp', 'tc', 3]] },
      { id: 'sorriso-12', rot: 1.3, enter: [-24, -18], exit: [-28, -20], fasteners: [['tape-02.webp', 'tc', -4]] },
      { id: 'sorriso-14', rot: -0.7, enter: [-12, 28], exit: [-16, 28], fasteners: [['tape-03.webp', 'tc', 0]] },
      { id: 'sorriso-15', rot: 1.5, enter: [30, -8], exit: [34, -10], fasteners: [['tape-04.webp', 'tc', 3], ['laco-03.webp', 'tr', 6]] },
      { id: 'sorriso-17', rot: 0.8, enter: [28, 10], exit: [34, 10], fasteners: [['tape-05.webp', 'tc', -2]] },
      { id: 'sorriso-18', rot: -1.1, enter: [26, 22], exit: [32, 24], fasteners: [['tape-06.webp', 'tc', 0]] },
    ],
    deco: [
      { key: 'anatomico', file: 'anatomico.webp', rot: -4, enter: [18, -18], exit: [22, -20] },
      { key: 'lolipop', file: 'lolipop.webp', rot: -2, enter: [22, 6], exit: [26, 8] },
      { key: 'lovesongstape', file: 'lovesongstape.webp', rot: -6, enter: [-24, 12], exit: [-28, 16] },
      { key: 'angel-02', file: 'angel-02.webp', rot: 2, enter: [24, -16], exit: [28, -20] },
      { key: 'rosa', file: 'rosa.webp', rot: -4, enter: [-26, 2], exit: [-30, 6] },
      { key: 'flor-01', file: 'flor-01.webp', rot: 0, enter: [26, 16], exit: [30, 18] },
      { key: 'carta', file: 'carta.webp', rot: 4, enter: [24, -6], exit: [28, -10] },
      { key: 'laco-03', file: 'laco-03.webp', rot: 7, enter: [0, 20], exit: [0, 24] },
      { key: 'selo-01', file: 'selo-01.webp', rot: -4, enter: [10, 14], exit: [14, 18] },
    ...
    <div class="smile-v5__section">
      <div class="smile-v5__sticky">
        ...
        <div class="smile-v5__scene-stage">
          ...
          <img class="smile-v5__center-title" src="${assetBase}/love-scene/kit/amoseusorriso.webp" alt="Amo o seu sorriso" draggable="false" />
